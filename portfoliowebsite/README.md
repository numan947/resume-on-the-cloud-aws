...
This is the source code for my personal website. It is built using the [Beautiful Jekyll](https://beautifuljekyll.com/)  By [Dean Attali](https://deanattali.com).
...
> &middot; [Demo](https://beautifuljekyll.com/)
